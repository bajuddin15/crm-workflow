  ...
  return (
    <>
      <div className="flex items-center gap-4">
        {/* <input
          className="w-1/3 border border-gray-400 text-gray-600 p-2 outline-none focus:ring-1 focus:ring-blue-500 rounded-md bg-white"
          type="text"
          value={formData.key}
  ...
  return (
    <>
      <div
        ...
        className="py-2 px-4 border border-gray-400 cursor-pointer"
      >
          ...
          {item?.unqName === "restApi" && (
            <div className="space-y-5">
              ...
              <div className="text-sm space-y-1 text-gray-600">
                ...
                <input
                  id="apiEndPointUrl"
                  className="w-full bg-inherit text-gray-600 px-4 py-2 outline-none text-sm  placeholder:text-sm placeholder:font-normal placeholder:text-gray-400 rounded-md border border-gray-400 focus:ring-1 focus:ring-blue-500"
                  type="text"
